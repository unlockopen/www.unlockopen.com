...
class Logo extends React.Component {
  render() {
      ...
      const colors = [brand.WORDMARK_FONT_COLOR_UNLOCK, brand.WORDMARK_FONT_COLOR_OPEN];
      ...
      const lm = <Logomark size={size} style={{ marginRight: rhythm(size/4), paddingBottom: `calc(${rhythm(3/10)} - 5px)` }}/>
